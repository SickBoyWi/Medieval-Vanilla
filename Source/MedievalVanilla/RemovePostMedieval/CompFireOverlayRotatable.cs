...
namespace MedievalVanilla
{
    ...
    public class CompFireOverlayRotatable : ThingComp
    {
        ...
        // This needs to be readonly, otherwise the game will complain.
        ...
        public override void PostDraw()
        {
            try
            {
                ...
                switch (thing.Rotation.AsInt)
                {
                    ...
                    case 3: // east
                        ...
                        break;
                    default:
                        throw new Exception($"The End Times: CompFire found thing {thing} with invalid rotation.");
                }
            ...
            {
                // Do nothing.
                //Log.Message($"The End Times: CompFire caught exception {e}.");
            }
        }
        ...
        {
            if (rando == 0)
                rando = UnityEngine.Random.Range(0, 24735);
            int timeTicks = Find.TickManager.TicksGame;
            int timeTicksScrambled = timeTicks + rando;
